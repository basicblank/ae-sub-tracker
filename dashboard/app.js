// Sample data structure - Replace with actual Google Sheets API data
let subscriptionData = {
    subscriptions: [
        {
            email: "user1@example.com",
            category: "Paid Stripe",
            active: "Yes",
            activeMonths: 3,
            paid: 39,
...
// Load data from Google Sheets (placeholder for API integration)
function loadData() {
